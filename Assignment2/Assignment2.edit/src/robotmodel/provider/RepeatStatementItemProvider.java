		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RepeatStatement_statements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RepeatStatement_statements_feature", "_UI_RepeatStatement_type"),
				 RobotmodelPackage.Literals.REPEAT_STATEMENT__STATEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIntegerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RepeatStatement_integer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RepeatStatement_integer_feature", "_UI_RepeatStatement_type"),
				 RobotmodelPackage.Literals.REPEAT_STATEMENT__INTEGER,
				 true,
				 false,
				 true,
				 null,
